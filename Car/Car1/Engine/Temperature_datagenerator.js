...
module.exports = {
  Temperature_datagenerator: function(namespaceIndex, namespace /* addressSpace */, SharedCarProperties, TimingSharedProperties, Engine) {
    ...
    namespace.addVariable({
      componentOf: Engine,
      nodeId: "ns=" + namespaceIndex + ";s=Temperature", // some opaque NodeId in namespace 4
